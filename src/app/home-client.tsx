...
export default function HomeClient({
  ...
  const { products: contextProducts, trips: contextTrips, programs: contextPrograms, addToCart } = useApp();
          ...
          >
            {featuredPrograms.map((program) => {
              ...
              if (program.target === "girls") {
                targetBgClass = "bg-rose-600/90";
                targetText = "للفتيات";
              } else if (program.target === "boys") {
                targetBgClass = "bg-blue-600/90";
                targetText = "للبنين";
              }
                  ...
                  <div className="p-6 flex-1 flex flex-col justify-between space-y-4 text-right">
                    ...
                    <div className="flex justify-between items-center pt-4 border-t border-slate-50">
                      ...
                      <MotionLink
                        ...
                        whileTap={{ scale: 0.95 }}
                        className="px-4 py-2 bg-accent-yellow hover:bg-primary-yellow text-white rounded-lg text-xs font-bold transition-all duration-300 cursor-pointer"
                      >
                        سجل الآن
                      </MotionLink>
                    </div>
          ...
          {featuredProducts.map((product) => {
            ...
            return (
              ...
              >
                ...
                {/* Product Image */}
                <div className="h-64 w-full bg-slate-55 overflow-hidden relative">
                  <Link href={productLink} className="w-full h-full block relative">
                    <Image
