    ...
    return (
      <div className="bg-slate-50 min-h-screen pt-28 pb-10 text-right font-tajawal">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
          ...
          {/* Welcome Section */}
          <div className="bg-gradient-to-r from-accent-teal to-primary-teal rounded-3xl p-6 sm:p-8 text-white relative overflow-hidden shadow-xl border border-primary-teal/50 flex flex-col md:flex-row justify-between items-center gap-6">
  ...
  return (
    <div className="bg-slate-50 min-h-screen pt-28 pb-10 text-right font-tajawal">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        {/* Welcome Section */}
        <div className="bg-gradient-to-r from-accent-teal to-primary-teal rounded-3xl p-6 sm:p-8 text-white relative overflow-hidden shadow-xl border border-primary-teal/50">
          <div className="absolute -left-10 -bottom-10 w-40 h-40 bg-accent-yellow/10 rounded-full blur-2xl" />
          <div className="absolute right-1/3 -top-12 w-60 h-60 bg-blue-500/5 rounded-full blur-3xl" />
