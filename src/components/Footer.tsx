        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-3 pt-3">
              <a
                href="https://snapchat.com/t/Z1kzsdL3"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-xl bg-slate-800/80 hover:bg-accent-yellow hover:text-white flex items-center justify-center transition-all duration-300 hover:scale-110 text-slate-450"
                aria-label="سناب شات"
              >
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24" aria-hidden="true">
                  <path d="M12.01 2.01c2.16 0 4.14 1 5.37 2.72.68.96.9 2.08.64 3.2-.28 1.18-1 2.03-1.94 2.52-.36.19-.5.5-.23.82.91 1.09 2.25 1.94 4 2.45.67.2 1.02.6.85 1.13-.15.5-.78.78-1.8.78-1.1 0-2.52-.16-3.84-.44-.39-.08-.7.13-.93.58l-.13.25c-.77 1.48-2.22 2.74-4.23 3.52-.61.24-.8.47-1.02.83h-.04c-.22-.36-.4-.6-.94-.83-1.98-.82-3.45-2.1-4.24-3.6l-.1-.22c-.22-.44-.54-.66-.94-.58-1.3.28-2.73.44-3.83.44-1.02 0-1.65-.28-1.8-.78-.17-.53.18-.93.85-1.13 1.75-.5 3.1-1.36 4-2.45.27-.32.13-.63-.23-.82-.94-.5-1.66-1.34-1.94-2.52-.26-1.12-.04-2.24.64-3.2 1.23-1.72 3.2-2.72 5.37-2.72z" />
                </svg>
              </a>
              <a
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-xl bg-slate-800/80 hover:bg-accent-yellow hover:text-white flex items-center justify-center transition-all duration-300 hover:scale-110 text-slate-455"
                aria-label="تيك توك"
              >
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24" aria-hidden="true">
